...
namespace LabFlybillettIfElse
{
    internal class Program
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("Tast inn billetpris: ");
            fullPris = int.Parse(Console.ReadLine());
            Console.WriteLine("Tast in alder: ");
            alder = int.Parse(Console.ReadLine());

            if (alder < 2)
            {
                sum = 100 * 0.1;
                prisEtterRabatt = fullPris * (sum / 100);
                Console.WriteLine("Din billetpris er: ");
                Console.WriteLine(prisEtterRabatt);
            }
            else if (alder == 2 || alder > 2 && alder < 13)
            {
                sum = 100 * 0.5;
                prisEtterRabatt = fullPris * (sum / 100);
                Console.WriteLine("Din billetpris er: ");
            ...
            else if (alder == 13 || alder > 13 && alder < 19)
            {
                sum = 100 * 0.7;
                prisEtterRabatt = fullPris * (sum / 100);
                Console.WriteLine("Din billetpris er: ");
            ...
            else if (alder == 19 || alder > 19 && alder < 67)
            {
                Console.WriteLine("Din billetpris er: ");
                Console.WriteLine(fullPris);
            }
            else if (alder == 67 || alder > 67)
            {
                sum = 100 * 0.6;
                prisEtterRabatt = fullPris * (sum / 100);
                Console.WriteLine("Din billetpris er: ");
